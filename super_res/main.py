...
img_lr_dir = 'data/set5_lr_sigma4/'
...
# for i in tqdm(range(1)):
    ...
    if isdir('data/results/set5_sigma4/' + dict_name + '_' + img_name_dir) == False:
        new_dir = mkdir('{}{}'.format('data/results/set5_sigma4/' + dict_name + '_', img_name_dir))
    img_lr = io.imread('{}{}'.format(img_lr_dir, img_name))

    ## READ AND SAVE ORIGINAL IMAGE
    img_hr = io.imread('{}{}'.format(img_hr_dir, img_name))
    io.imsave('{}{}{}{}'.format('data/results/set5_sigma4/' + dict_name + '_', img_name_dir, '/', '3HR.png'), img_hr)
    ...
    np.savetxt('{}{}{}{}'.format('data/results/set5_sigma4/' + dict_name + '_', img_name_dir, '/', 'PSNR_SR.txt'), psnr_sr_hr)

    ## SAVE SUPER-RESOLVED IMAGE
    io.imsave('{}{}{}{}'.format('data/results/set5_sigma4/' + dict_name + '_', img_name_dir, '/', '2SR.png'), img_sr)
